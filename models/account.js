...
MusicAdmin.belongsTo(Musics, {
  ...
  Message.belongsTo(RequestAdmin, {
  ...
  module.exports = {Profiles,Message, Musics, Accounts,SubCategory, Category, MusicAdmin, AccountType, AccountStatus, RequestAdmin}